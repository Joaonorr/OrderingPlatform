...
namespace OrderingPlatform.Migrations
{
    ...
    [Migration("20230117001126_AddTableOrders")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrderingPlatform.Domain.Orders.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OrderProduct", b =>
                {
                    b.HasOne("OrderingPlatform.Domain.Orders.Order", null)
                        .WithMany()
                        .HasForeignKey("OrdersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OrderingPlatform.Domain.Products.Product", null)
                        .WithMany()
